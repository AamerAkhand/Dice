...
from characters import Lapper, Huntsman
...
# ===== GAME STATE =====
# Game screen state
game_state = "start"  # Can be "start", "character_select", "yellow_tile_select", or "battle"
...
yellow_tile_select = None  # Will be initialized after character selection
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if game_state == "start":
                ...
                if selected_character is not None:
                    ...
                    player_current_hp = current_character.max_hp
                    # Initialize yellow tile select screen with chosen character
